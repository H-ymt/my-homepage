...
export default function Header() {
  ...
  return (
    <header className='shadow-blue-20 sticky top-0 z-20 h-[64px] border-b border-[#0f172a1a] bg-background/90 bg-opacity-20 backdrop-filter dark:border-[#cbd5e11a] dark:bg-[#4f4e4e10]'>
