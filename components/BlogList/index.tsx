        ...
        {posts.map((post) => (
          <li key={post.id}>
            <Link
              ...
              target="blank"
              className="inline-flex flex-col items-center justify-center gap-4 w-[300px] min-h-[220px] max-w-[320px] p-6 border-2 bg-orange-200 dark:bg-blue-200/30 border-none rounded-3xl hover:scale-[1.02] duration-200 transition-all"
            >
